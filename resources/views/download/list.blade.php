          ...
          <table class="table table-striped">
            ...
            <tr>
              ...
              <td>
                ...
                <a href="{{ url('/downloads/delete/'.$download->id) }}"><i class="fas fa-trash-alt" title="Eliminar"></i></a>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-body">
                        <p>Esta seguro que desea eliminar el archivo  <strong> "{{ $download->id }}"</strong></p>
                      </div>
                      <div class="modal-footer">
                        <a class="btn btn-secondary" data-dismiss="modal">Close</a>
                        <a class="btn btn-primary btn" href="{{ url('/downloads/delete/'.$download->id) }}">
                          Aceptar
                        </a>
                      </div>
                    </div>
