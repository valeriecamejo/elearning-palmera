              ...
              <select id="category_id" class="form-control{{ $errors->has('category_id') ? ' is-invalid' : '' }}" name="category_id" autofocus required>
                ...
                @endforeach
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<input id="model" type="text" class="form-control{{ $errors->has('model') ? ' is-invalid' : '' }}" name="model" value="{{ $product->model }}" required autofocus>
							@if ($errors->has('model'))
								<span class="invalid-feedback">
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<input id="version" type="text" class="form-control{{ $errors->has('version') ? ' is-invalid' : '' }}" name="version" value="{{ $product->version }}" required autofocus>
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<input id="valoration" type="text" class="form-control{{ $errors->has('valoration') ? ' is-invalid' : '' }}" name="valoration" value="{{ $product->valoration }}" required autofocus>
