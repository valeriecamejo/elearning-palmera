    ...
    <div class="col-md-8">
      <div class="card">
        ...
        <template v-if="countries != ''">
          <div class="card-body">
          <h5 class="card-title">Editar Tienda {{ $store->name }}</h5>
            <form method="POST" action="{{ url('/stores/edit/'.$store->id) }}">
              @csrf
              <div class="form-group row">
                <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Pais') }}</label>
                <div class="col-md-6">
                  <select v-model="previous_country" @click="statesOfCountry(previous_country)" name="country_id" class="form-control" required autofocus>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ $store->name }}" required autofocus>
                @if ($errors->has('name'))
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                <input id="address" type="text" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{ $store->address }}" autofocus>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" id="description" rows="3" value="{{ $store->description }}"
